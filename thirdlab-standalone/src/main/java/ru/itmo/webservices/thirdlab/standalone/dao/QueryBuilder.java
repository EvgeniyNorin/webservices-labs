...
public class QueryBuilder {
    static String buildSelect(String authorId, Long hIndex, String articleName, String articleDesc, Long dateAdded) {
    ...
    static String buildUpdate(Long id, String authorId, Long hIndex, String articleName, String articleDesc, Long dateAdded) {
        StringBuilder builder = new StringBuilder(0);
        if (authorId != null) {
            builder.append(String.format("author_id='%s'", authorId));
        }
        ...
        if (builder.length() != 0) {
            return "update article SET " + builder.toString() + " where article_id=" + id.toString() + ";";
        } else {
            return null;
        }
    }
