 ...
 * generated in the ru.itmo.webservices.secondlab.standalone package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetArticlesResponse_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "getArticlesResponse");
    private final static QName _UpdateArticle_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "updateArticle");
    private final static QName _CreateArticle_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "createArticle");
    private final static QName _CreateArticleResponse_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "createArticleResponse");
    private final static QName _GetArticles_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "getArticles");
    private final static QName _DeleteArticle_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "deleteArticle");
    private final static QName _DeleteArticleResponse_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "deleteArticleResponse");
    private final static QName _UpdateArticleResponse_QNAME = new QName("http://standalone.secondlab.webservices.itmo.ru/", "updateArticleResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.itmo.webservices.secondlab.standalone
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "getArticlesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "updateArticle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "createArticle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "createArticleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "getArticles")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "deleteArticle")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "deleteArticleResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://standalone.secondlab.webservices.itmo.ru/", name = "updateArticleResponse")
